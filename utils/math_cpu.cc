...
#define KURFF_SPECIALIZED_ROWWISEMAX(T)                                       \
...
KURFF_SPECIALIZED_ROWWISEMAX(float)

#define KURFF_SPECIALIZED_COLWISEMAX(T)                                       \
template <> void ColwiseMax<T, CPUContext>(                                    \
    const int N, const int D, const T* x, T* y, CPUContext* context) {         \
  EigenVectorMap<T>(y, D) =                                                    \
      ConstEigenMatrixMap<T>(x, D, N).rowwise().maxCoeff();                    \
}
KURFF_SPECIALIZED_COLWISEMAX(float)
...
#define KURFF_SPECIALIZED_SET(T)                                          \
template <>                                                                    \
...
KURFF_SPECIALIZED_SET(float);
KURFF_SPECIALIZED_SET(double);
KURFF_SPECIALIZED_SET(int);
#undef KURFF_SPECIALIZED_SET
